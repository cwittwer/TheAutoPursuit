...
query_use = 'Duramax High Country'
...
try:
    ...
    twit_app = twit.twit_use(tt.car_bot_twit_tokens)
    ...
    for i,j in site_list.iterrows(): 
        ...
        cl_fs_car = CraigslistForSale(site=j['site'], category=cat_use, 
                                        filters={'query': query_use, 'has_image': True, 'search_titles': True
